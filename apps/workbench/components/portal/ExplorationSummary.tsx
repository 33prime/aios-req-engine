      ...
      <div className="max-w-md mx-auto text-center px-6">
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          <div className="bg-white/10 rounded-xl p-3">
            <ThumbsUp className="w-5 h-5 mx-auto mb-1 text-brand-primary" />
        ...
        <button
          ...
          className="px-8 py-3.5 bg-brand-primary text-white text-base font-medium rounded-xl hover:bg-brand-primary-hover transition-all shadow-lg shadow-brand-primary/25 disabled:opacity-50"
        >
