  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[#3FAF7A]/10 text-[#25785A] font-medium">
          {clusters.length}
        </span>
      </div>
      ...
      {clusters.map(cluster => {
        ...
        return (
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-2 shrink-0 ml-2">
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1 text-[11px] font-medium text-[#3FAF7A] bg-[#3FAF7A]/5 rounded-md hover:bg-[#3FAF7A]/10 transition-colors disabled:opacity-50"
                >
            ...
            {isExpanded && (
              <div className="border-t border-[#E5E5E5] bg-gray-50/50 px-3 py-2 space-y-1">
                {cluster.entities.map(entity => (
                  ...
                  >
                    ...
                    <span className="text-[#333333] truncate">{entity.name}</span>
                  </div>
                ))}
              </div>
            )}
