    ...
    <section>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-[16px] font-semibold text-[#333333]">MVP Features</h2>
      ...
      {features.length > 0 && (
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-[11px] text-[#999999] w-10 text-right">{progressPct}%</span>
        </div>
      )}

      {features.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-md border border-[#E5E5E5] px-6 py-8 text-center">
          <Package className="w-8 h-8 text-[#999999] mx-auto mb-3" />
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="text-[14px] font-semibold text-[#333333]">{feature.name}</span>
              ...
              <div className="flex items-center gap-2 mt-2 flex-wrap">
                ...
                {feature.vp_step_id && (
                  <span className="text-[10px] text-[#999999]">Mapped to workflow step</span>
                )}
              </div>
            </div>
          ))}
