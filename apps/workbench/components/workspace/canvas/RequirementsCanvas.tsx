  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* Stats Micro-bar */}
        <div className="flex items-center justify-end gap-4 text-[11px] text-text-placeholder">
          <span>Features: <strong className="text-text-body">{totalFeatures}</strong>{mvpFeatures > 0 && <> (<strong className="text-amber-600">{mvpFeatures} MVP</strong>)</>}</span>
          <span className="w-px h-3 bg-border" />
          <span>Steps: <strong className="text-text-body">{data.vp_steps.length}</strong></span>
          <span className="w-px h-3 bg-border" />
          <span>Mapped: <strong className="text-text-body">{mappedFeatures}/{totalFeatures}</strong> ({mappedPct}%)</span>
          <span className="w-px h-3 bg-border" />
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              <h2 className="text-base font-semibold text-text-body">Actors</h2>
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-base font-semibold text-text-body">Journey</h2>
            <span className="text-[12px] text-text-placeholder">
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-base font-semibold text-text-body">Unmapped Features</h2>
            <span className="text-[12px] text-text-placeholder">
