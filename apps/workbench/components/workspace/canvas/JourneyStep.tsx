    ...
    <div className="flex items-start gap-4">
      ...
      <div
        ...
        className={`
          ...
          ${isOver
            ? 'border-brand-primary bg-emerald-50/50 shadow-md'
      ...
      >
        {/* Header */}
        <div
          className="px-4 py-3 border-b border-gray-100 cursor-pointer hover:bg-surface-muted/50 transition-colors"
        ...
        >
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-text-body text-sm">{step.title}</h3>
              {(() => {
          ...
          {step.actor_persona_name && (
            <div className="flex items-center gap-1 mt-1.5">
              ...
              <span className="text-[12px] text-text-placeholder">{step.actor_persona_name}</span>
            </div>
          )}

          {/* Description */}
          {step.description && (
            <p className="text-[12px] text-text-placeholder mt-2 line-clamp-2">
              {step.description}
            </p>
          )}
        </div>
        ...
        <div className="p-3 min-h-[80px]">
          {step.features.length > 0 ? (
            ...
            <div className={`
              ...
              ${isOver ? 'border-brand-primary bg-emerald-50' : 'border-border'}
            `}>
