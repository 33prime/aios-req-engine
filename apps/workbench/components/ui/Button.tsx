...
export function Button({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-surface-subtle text-text-body hover:bg-border active:bg-border-strong',
    outline: 'bg-white border border-brand-primary text-brand-primary hover:bg-brand-primary-light active:bg-brand-primary-light',
    ghost: 'bg-transparent text-text-body hover:bg-gray-100 active:bg-gray-200'
  }
