      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-[520px] mx-4">
        ...
        <div className="px-6 py-4 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-[13px] border border-border rounded-xl focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary/20 transition-colors"
              autoFocus
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-[13px] border border-border rounded-xl focus:outline-none focus:border-brand-primary transition-colors appearance-none cursor-pointer"
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 text-[13px] border border-border rounded-xl focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary/20 transition-colors resize-none"
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-border">
          ...
          <button
            ...
            className="px-4 py-2 text-[13px] font-medium text-white bg-brand-primary rounded-xl hover:bg-[#25785A] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
