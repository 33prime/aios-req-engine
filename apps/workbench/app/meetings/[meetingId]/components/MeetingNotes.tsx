  ...
  return (
    <div className="mt-7">
      <div className="flex items-center gap-2 mb-3.5">
        <span className="text-[15px] font-semibold text-[#1D1D1F]">Meeting Notes</span>
        {summary && (
      ...
      <div className="bg-white border border-[#E5E5E5] rounded-lg p-4 min-h-[120px]">
        {summary ? (
          <div className="text-[13px] text-[#4B4B4B] leading-relaxed whitespace-pre-wrap">
            {summary}
          </div>
        ) : (
