      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[12px] font-medium text-white bg-[#3FAF7A] rounded-md hover:bg-[#25785A] transition-colors"
          >
      ...
      <div className="flex items-center justify-between border-b border-gray-200 mb-4">
        <div className="flex gap-0">
          {tabs.map((tab) => (
            ...
            >
              {tab.dot && (
                <span className="w-[6px] h-[6px] rounded-full bg-[#3FAF7A]" />
              )}
              {tab.label}
              <span
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative flex-1 min-w-[200px] max-w-[320px]">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-[13px] bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-[#3FAF7A] focus:border-[#3FAF7A]"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-1.5 text-[13px] bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-[#3FAF7A]"
        >
