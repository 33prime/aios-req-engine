  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-ui-supportText">Debug auto-trigger workflow and job execution</p>
      </div>
      ...
      <Card>
        ...
        <div className="space-y-3">
          <div>
            <div className="text-sm font-medium text-ui-bodyText mb-1">Project Name</div>
            <div className="text-lg text-ui-bodyText">{project?.name || 'Unknown'}</div>
          </div>
          <div>
            <div className="text-sm font-medium text-ui-bodyText mb-1">PRD Mode</div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-ui-supportText">
                {project?.prd_mode === 'initial'
      ...
      <Card>
        ...
        {jobs.length === 0 ? (
          <div className="text-center py-8 text-ui-supportText">
            ...
            {jobs.map((job) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="font-mono text-sm font-medium text-ui-bodyText">
                      {job.job_type}
                    </span>
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div>
                    <div className="text-ui-supportText mb-1">Input</div>
                    <pre className="bg-gray-50 p-2 rounded overflow-x-auto">
                      {JSON.stringify(job.input_json, null, 2)}
                    </pre>
                  </div>
                  <div>
                    <div className="text-ui-supportText mb-1">Output</div>
                    <pre className="bg-gray-50 p-2 rounded overflow-x-auto">
                ...
                <div className="mt-2 text-xs text-ui-supportText font-mono">
                  ID: {job.id}
                </div>
              </div>
            ))}
      ...
      <Card>
        ...
        <div className="space-y-4 text-sm">
          <div>
            <h4 className="font-medium text-ui-bodyText mb-2">
              ❌ Problem: "No jobs recorded" after adding signal
            </h4>
            <ul className="list-disc list-inside space-y-1 text-ui-supportText ml-4">
          ...
          <div>
            ...
            <ol className="list-decimal list-inside space-y-1 text-ui-supportText ml-4">
