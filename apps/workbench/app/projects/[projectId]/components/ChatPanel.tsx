    ...
    return (
      <div className="fixed bottom-4 right-4 sm:bottom-4 sm:right-4 z-50">
        <button
          ...
          className="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-brand-primary to-[#25785A] text-white rounded-lg shadow-lg hover:shadow-xl transition-all"
        >
  ...
  return (
    <>
      ...
      >
        {/* Drag overlay */}
        {isDragging && (
          <div className="absolute inset-0 z-50 bg-brand-primary-light border-2 border-dashed border-brand-primary rounded-lg flex items-center justify-center pointer-events-none">
            <div className="text-center p-6">
              ...
              <p className="text-sm text-text-placeholder mt-1">PDF, DOCX, XLSX, PPTX, or images (max 5)</p>
            </div>
          </div>
        )}
        ...
        {uploadingFiles && (
          <div className="absolute inset-0 z-50 bg-white/90 flex items-center justify-center">
            <div className="text-center p-6">
              ...
              <p className="text-base font-medium text-text-body">Uploading files...</p>
            </div>
          </div>
        )}

        {/* Header */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gradient-to-r from-brand-primary to-[#25785A] flex-shrink-0">
        ...
        <div className="px-3 sm:px-4 py-2 sm:py-3 border-b border-gray-100 bg-gray-50 flex-shrink-0">
          <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-hide">
            <span className="text-xs text-text-placeholder whitespace-nowrap flex items-center gap-1">
        ...
        <div className="border-t border-gray-200 bg-white px-4 sm:px-6 py-3 sm:py-4 flex-shrink-0 pb-safe">
          <form onSubmit={handleSubmit} className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-brand-primary hover:bg-[#25785A] text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
...
function ProactiveMessageCard({
  ...
  const priorityIcon = {
    ...
    low: <Info className="h-4 w-4 text-brand-primary" />,
  }
        ...
        {!isUser && message.toolCalls && message.toolCalls.length > 0 && (
          <div className="mt-2">
            ...
            <button
              ...
              className="flex items-center gap-2 text-xs text-text-placeholder hover:text-text-body transition-colors mb-1"
            >
              <Sparkles className="h-3 w-3" />
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {tool.status === 'complete' && tool.result?.message && (
                        <div className="text-text-placeholder mt-0.5 line-clamp-2">
