    ...
    if wf_count == 0:
        skeletons.append(
            ActionSkeleton(
                ...
                gap_description="Map your first workflow to define the current process",
    ...
    if kpi_count == 0:
        skeletons.append(
            ActionSkeleton(
                ...
                gap_domain=GapDomain.DRIVER,
                gap_type="no_kpis",
                gap_description="Define success metrics to measure impact",
                primary_entity_type="project",
                primary_entity_id=inputs.get("project_id", ""),
                primary_entity_name="Project",
                base_score=80,
    ...
    if not inputs.get("has_vision"):
        skeletons.append(
            ActionSkeleton(
                ...
                gap_domain=GapDomain.DRIVER,
                gap_type="no_vision",
                gap_description="Add a vision statement to anchor the project",
                primary_entity_type="project",
                primary_entity_id=inputs.get("project_id", ""),
                primary_entity_name="Project",
                base_score=72,
