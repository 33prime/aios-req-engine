...
class CTAType(str, Enum):
    ...
    OPEN_CHAT = "open_chat"  # Default — opens chat with rich context
    BOOK_MEETING = "book_meeting"  # Opens chat primed to schedule a call
    MEETING_PREP = "meeting_prep"  # Opens chat with prep context
...
class StrategicAction(BaseModel):
    """A consultant-serving next action from the intelligence synthesis.

    Generated by Haiku — focuses on what a $300/hr consultant should DO,
    not what a database is missing.
    """

    sentence: str
    action_type: str  # explore|interview|validate|signal|synthesize|confirm
    entity_type: str | None = None
    entity_name: str | None = None
    stakeholder_name: str | None = None
    cta_type: str = "open_chat"
    cta_label: str = "Start conversation"
    chat_context: str = ""
    insight_rationale: str = ""
