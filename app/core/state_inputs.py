...
def build_state_prompt(
    ...
    lines = [
        ...
        "1. PRD sections (software_summary, personas, key_features, happy_path, constraints, etc.)",
        ...
        "",
        "## Instructions",
        "- Create at least 4 PRD sections (software_summary, personas, key_features, happy_path are required).",
        "- software_summary should include: brief overview of the software, key capabilities, and target users.",
        "- constraints section is optional but should be created if technical, security, or business constraints are mentioned.",
        "- Create at least 7 Value Path steps describing the user workflow.",
        "- Create at least 2 Persona entities with full details (slug, name, role, demographics, psychographics, goals, pain_points, description).",
        "- Create at least 8 Key Features with appropriate categories.",
        ...
        "- CRITICAL: Every PRD section, VP step, and feature MUST include evidence entries with chunk_ids from the provided chunks.",
        "- Each evidence entry must have: chunk_id (from provided chunks), excerpt (verbatim text, max 280 chars), and rationale.",
