    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "ai_config": {
                "type": "object",
                "properties": {
                    "role": {"type": "string", "description": "What the AI does — the intelligence layer"},
                    "agent_name": {"type": "string", "description": "Short human-friendly name for the AI agent"},
                    "agent_type": {
                        "type": "string",
                        "enum": ["classifier", "matcher", "predictor", "watcher", "generator", "processor"],
                        "description": "Primary behavior pattern",
                    },
                    "behaviors": {"type": "array", "items": {"type": "string"}, "description": "Specific AI behaviors (3-5 actions)"},
                    ...
                    "fallback": {"type": "string", "description": "What happens when AI is unavailable"},
                    "data_requirements": {
                        "type": "array",
                        "items": {
                            "type": "object",
                    ...
                    "automation_estimate": {"type": "integer", "description": "Estimated % automated (0-100)"},
                ...
                "description": "AI agent configuration. Preserve all fields when updating — only change what the user asked about.",
            },
        },
    },
}
